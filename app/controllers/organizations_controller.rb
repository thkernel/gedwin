class OrganizationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @organization.save
        ...
        format.html { redirect_to show_organization_path(@organization.uid), notice: 'Enregistrer avec succès.' }
  ...
  def update
    respond_to do |format|
      if @organization.update(organization_params)
        ...
        format.html { redirect_to show_organization_path(@organization.uid), notice: 'Modifier avec succès.' }
  ...
  def destroy
    ...
    respond_to do |format|
      ...
      format.html { redirect_to organizations_url, notice: 'Supprimer avec succès.' }
