  ...
  def create
    ...
    respond_to do |format|
      if @imputation.save
        ...
        format.html { redirect_to imputations_path(uid: flash[:rtype].constantize.find(@imputation.imputable_id).uid, rtype: flash[:rtype]), notice: 'Imputé avec succès.' }
  ...
  def update
    ...
    respond_to do |format|
      if @imputation.update(imputation_params)
        ...
        format.html { redirect_to imputations_path(uid: @imputation.imputable_type.constantize.find(@imputation.imputable_id).uid, rtype: @imputation.imputable_type), notice: 'Supprimer avec succès.' }
