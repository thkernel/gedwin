class CorrespondentTypesController < ApplicationController
  ...
  def index
    ...
    record_activity("Afficher la liste des types correspondant")
  ...
  def create
    ...
    respond_to do |format|
      if @correspondent_type.save
        ...
        format.html { redirect_to @correspondent_type, notice: 'Enregistrer avec succès.' }
  ...
  def update
    respond_to do |format|
      if @correspondent_type.update(correspondent_type_params)
        ...
        format.html { redirect_to @correspondent_type, notice: 'Modifier avec succès.' }
  ...
  def destroy
    ...
    respond_to do |format|
      ...
      format.html { redirect_to correspondent_types_url, notice: 'Supprimer avec succès.' }
