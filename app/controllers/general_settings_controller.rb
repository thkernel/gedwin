class GeneralSettingsController < ApplicationController
  ...
  def create
    @general_setting = current_user.build_general_setting(general_setting_params)

    respond_to do |format|
      if @general_setting.save
        format.html { redirect_to edit_general_setting_path(@general_setting), notice: 'General setting was successfully created.' }
  ...
  private
    ...
    def general_setting_params
      params.require(:general_setting).permit(:application_name, :login_screen_message, :home_screen_message, :logo, :wallpaper)
    end
end
