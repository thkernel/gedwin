...
class TaskStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_status" do
    assert_difference('TaskStatus.count') do
      post task_statuses_url, params: { task_status: { description: @task_status.description, status: @task_status.status, title: @task_status.title, user_id: @task_status.user_id } }
    end
  ...
  test "should update task_status" do
    patch task_status_url(@task_status), params: { task_status: { description: @task_status.description, status: @task_status.status, title: @task_status.title, user_id: @task_status.user_id } }
