...
class TaskTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_type" do
    assert_difference('TaskType.count') do
      post task_types_url, params: { task_type: { description: @task_type.description, status: @task_type.status, title: @task_type.title, user_id: @task_type.user_id } }
    end
  ...
  test "should update task_type" do
    patch task_type_url(@task_type), params: { task_type: { description: @task_type.description, status: @task_type.status, title: @task_type.title, user_id: @task_type.user_id } }
